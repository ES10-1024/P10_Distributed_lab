...
ADMM_1 = dataProc(folder+'ADMM1_05-03_13-34-55.csv')
ADMM_2 = dataProc(folder+'ADMM2_05-03_13-34-55.csv')
ADMM_3 = dataProc(folder+'ADMM3_05-03_13-34-55.csv')
pump1 = dataProc(folder+'pump1_05-03_13-34-53.csv')
pump2 = dataProc(folder+'pump2_05-03_13-34-55.csv')
pump2_ctrl = dataProc(folder+'pump_ctrl2_05-03_13-34-53.csv')
pump3_ctrl = dataProc(folder+'pump_ctrl3_05-03_13-34-55.csv')
rw_con= dataProc(folder+'return_and_consumer_valve_ctrl_05-03_13-34-56.csv');
tow = dataProc(folder+'tower_05-03_13-34-52.csv')
toc

save(folder+'05-03_13-34.mat')
%%
clear 
folder = "Logging/Log_files/"
folder = "C:\Users\pppc\Desktop\Test_data_Lau_lauridsen"
