...
folder = "C:\Users\pppc\Desktop\Test_data_Lau_lauridsen\privacy_preserving_smpc\"
ADMM_1 = dataProc(folder+'ADMM1_05-09_12-54-40.csv')
ADMM_2 = dataProc(folder+'ADMM2_05-09_12-54-40.csv')
ADMM_3 = dataProc(folder+'ADMM3_05-09_12-54-40.csv')
pump1 = dataProc(folder+'pump1_05-09_12-54-38.csv')
pump2 = dataProc(folder+'pump2_05-09_12-54-40.csv')
pump2_ctrl = dataProc(folder+'pump_ctrl2_05-09_12-54-39.csv')
pump3_ctrl = dataProc(folder+'pump_ctrl3_05-09_12-54-40.csv')
rw_con= dataProc(folder+'return_and_consumer_valve_ctrl_05-09_12-54-42.csv');
tow = dataProc(folder+'tower_05-09_12-54-36.csv')
toc
