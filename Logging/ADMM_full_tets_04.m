...
ADMM_1 = dataProc(folder+'ADMM1_05-17_09-34-01.csv')
ADMM_2 = dataProc(folder+'ADMM2_05-17_09-34-01.csv')
ADMM_3 = dataProc(folder+'ADMM3_05-17_09-34-01.csv')
pump1 = dataProc(folder+'pump1_05-17_09-33-59.csv')
pump2 = dataProc(folder+'pump2_05-17_09-34-01.csv')
pump2_ctrl = dataProc(folder+'pump_ctrl2_05-17_09-34-00.csv')
pump3_ctrl = dataProc(folder+'pump_ctrl3_05-17_09-34-01.csv')
rw_con= dataProc(folder+'return_and_consumer_valve_ctrl_05-17_09-34-03.csv');
tow = dataProc(folder+'tower_05-17_09-33-57.csv')
toc
