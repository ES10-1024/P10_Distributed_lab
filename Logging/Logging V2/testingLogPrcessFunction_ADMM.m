...
tic
 ADMM_1 = dataProc('ADMM1_05-14_13-27-13.csv') 
 ADMM_2 = dataProc('ADMM2_05-14_13-27-13.csv')
 ADMM_3 = dataProc('ADMM3_05-14_13-27-13.csv')
% pump2_ctrl = dataProc('pump_ctrl2_05-09_12-54-39.csv')
 %pump3_ctrl = dataProc('pump_ctrl3_05-09_12-54-41.csv')
 pump1=dataProc('pump1_05-14_13-27-09.csv')
 pump2=dataProc('pump2_05-14_13-27-13.csv') 
 tow = dataProc('tower_05-14_13-27-05')
