...
folder = "C:\Users\laula\OneDrive - Aalborg Universitet\10. semester\Log_files\Distributed_system_0\"
ADMM_1 = logProcces(folder+'ADMM1_05-02_11-32-14.csv')
ADMM_2 = logProcces(folder+'ADMM2_05-02_11-32-14.csv')
ADMM_3 = logProcces(folder+'ADMM3_05-02_11-32-14.csv')
pump1 = logProcces(folder+'pump1_05-02_11-32-12.csv')
pump2 = logProcces(folder+'pump2_05-02_11-32-14.csv')
pump2_ctrl = logProcces(folder+'pump_ctrl2_05-02_11-32-13.csv')
pump3_ctrl = logProcces(folder+'pump_ctrl3_05-02_11-32-14.csv')
rw_con=logProcces(folder+'return_and_consumer_valve_ctrl_05-02_11-32-16.csv');
tow = logProcces(folder+'tower_05-02_11-32-10.csv')

save(folder+'05-02_11-32.mat')
%%
clear 
folder = "Logging/Log_files/"
folder = "C:\Users\laula\OneDrive - Aalborg Universitet\10. semester\Log_files\Distributed_system_0\"
load(folder+'05-02_11-32.mat')
